...
export PUBLIC_SECURITY_NUMBER="${PUBLIC_SECURITY_NUMBER:-闽公网安备35018102240193号}"
export PUBLIC_SECURITY_URL="${PUBLIC_SECURITY_URL:-https://beian.mps.gov.cn/#/query/webSearch?code=35018102240193}"
